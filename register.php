      ...
      <div class="container">
        <div class="row" style="margin-top: -6em;">
          <div class="col-md-6 col-xs-12">
              ...
              <form action="post_action.php" method="POST">
                ...
                <div class="form-group row">
                  <div class="col-sm-12 col-xs-12">
                    ...
                    <label class="label_insta">Nous utilisons votre pseudo pour afficher votre photo de profil sur les listes.</label>
                  </div>
                </div>
                <div class="form-group">
                  <label>Sélectionner votre classe :</label>
                  <select class="form-control option_width" name="exampleFormControlSelect1">
                    <option value="" disabled required="">-- Choisir sa classe de 1ère --</option>
                    <option>1</option>
                    <option>2</option>
                    <option>3</option>
                    <option>4</option>
            ...
            <p class="p-class">Voir les classes sans m'inscrire : <br>
